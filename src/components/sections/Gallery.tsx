        ...
        <div className="mt-10 grid auto-rows-fr gap-5 md:grid-cols-2">
          {GALLERY.map((item) => (
            <article key={item.title} className="relative flex h-full flex-col overflow-hidden rounded-[30px] bg-white">
              ...
              <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(4,31,35,0.08)_15%,rgba(4,31,35,0.74)_100%)]" />
              <div className="absolute inset-x-0 bottom-0 p-6 text-white">
                <h3 className="text-balance text-2xl font-semibold leading-[0.93] tracking-[-0.055em] [font-family:var(--font-display)] sm:font-medium sm:leading-[0.98]">{item.title}</h3>
